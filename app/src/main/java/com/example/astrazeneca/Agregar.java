    ...
    public void initQR() {
        ...
        cameraView.getHolder().addCallback(new SurfaceHolder.Callback() {
            ...
            public void surfaceCreated(SurfaceHolder holder) {
                ...
                if (ActivityCompat.checkSelfPermission(Agregar.this, Manifest.permission.CAMERA)
            ...
            public void receiveDetections(Detector.Detections<Barcode> detections) {
                ...
                if (barcodes.size() > 0) {
                    ...
                    if (!token.equals(tokenanterior)) {
                        ...
                        Query phoneQuery = ref.orderByChild("Numero").equalTo(token.toString());
...
class Medicina {
    ...
    public Medicina(String nombre, String number, String dosis, String efectos) {
        this.Nombre = nombre;
        this.Number = number;
